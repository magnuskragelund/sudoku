...
/**
 * Push all available locale files to Apple App Store Connect
 * Automatically detects all locale JSON files and pushes them
 * Usage: node pushAllToAppStore.js
 */
...
/**
 * Run pushToAppStore.js for a specific locale
 */
function pushLocale(locale) {
  return new Promise((resolve, reject) => {
    ...
    const scriptPath = path.join(__dirname, 'pushToAppStore.js');
 ...
 */
async function main() {
  console.log('\n🌍 PUSH ALL LOCALES TO APP STORE CONNECT\n');
